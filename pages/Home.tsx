  ...
  return (
    <main className="flex-grow">
      <SEO
        ...
        description="A high-contrast, premium landing page for Epiphany Dynamics, specializing in industry-leading generative and traditional AI solutions."
        canonical="https://epiphanydynamics.com/"
      />
      <Hero />
